...
public class OrchestratorTest extends AbstractJUnit4SpringContextTests {
...
//		serviceManagerService.laddAllService();
	...
	public void process() {
		...
		LOG.trace("Test:OrchestratorTest.process");
		...
		Future<Object> future = producer.asyncRequestBody("seda:request", canonicalMessage);
