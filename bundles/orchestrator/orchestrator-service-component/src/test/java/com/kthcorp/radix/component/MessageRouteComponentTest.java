...
public class MessageRouteComponentTest extends AbstractJUnit4SpringContextTests {
...
//		serviceManagerService.laddAllService();
	...
	public void process() {
		...
		LOG.trace("Test:MessageRouteComponent.process");
...
//		parameters.put("access_token", "AAADkIkvLIjUBANxKgEBAqgUzL45RUpMl9T9zvoBUWsb5BRaCdH7VZAkVUzXYQabBh59C8EKeW8lWQyTOBV0kPEPXlC9MZD");
		...
		Future<Object> future = producer.asyncRequestBody("seda:messageRouteComponentTest", canonicalMessage);
