...
public class RadixJdbcTokenStore implements TokenStore {
	...
	private static final String DEFAULT_ACCESS_TOKEN_INSERT_STATEMENT = "insert into radix_oauth_access_token (token_id, token, authentication_id, authentication, refresh_token, client_id, username, scope) values (?, ?, ?, ?, ?, ?, ?, ?)";
