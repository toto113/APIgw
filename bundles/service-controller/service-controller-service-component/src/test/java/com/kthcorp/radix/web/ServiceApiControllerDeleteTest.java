...
public class ServiceApiControllerDeleteTest {
	...
	public void doServiceTest() throws ServletException, IOException, RadixException {
		...
		//when
		when(serviceManagerService.getURIString(platformDomain, HttpMethod.DELETE, "MapAPI", new ServiceVersion("1"), "map")).thenReturn("api.withapi.com::DELETE:/MapAPI/1/map");
