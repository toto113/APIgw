...
public class BizPortalOAuthTest extends AbstractJUnit4SpringContextTests {
	
	private static final Logger LOG = UuidViewableLoggerFactory.getLogger(BizPortalOAuthTest.class);
	
	@Autowired
	private RestOperations restTemplate;
	
	private static final String AUTHORIZE_URL = "http://211.113.53.126:8088/oauth/authorize";
	private static final String PLATFORM_URL = "http://211.113.53.126:8088/platform/clientKeys";
