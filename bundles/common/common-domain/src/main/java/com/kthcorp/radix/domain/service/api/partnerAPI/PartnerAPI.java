package com.kthcorp.radix.domain.service.api.partnerAPI;
...
public class PartnerAPI implements Serializable {
	
	private static final long serialVersionUID = 9048861506571302088L;
	private transient static final Logger LOG = UuidViewableLoggerFactory.getLogger(PartnerAPI.class);
	...
	public void setProtocolMeta(String protocolMeta) throws JSONException, NotSupportException {
		...
		this.protocolObj = ProtocolFactory.createProtocol(protocolType, ProtocolMode.CLIENT);
	...
	public String toString() {
		...
		jb.put("name", name);
		jb.put("transportType", transportType);
		jb.put("protocolType", protocolType);
		jb.put("protocolMeta", protocolMeta);
