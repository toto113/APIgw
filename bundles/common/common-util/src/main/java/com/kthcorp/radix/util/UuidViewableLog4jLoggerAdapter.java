...
/**
 * org.slf4j.impl.Log4jLoggerAdapter 소스를 그대로 카피해 왔다.
 * 그리고 오직 org.slf4j.helpers.MessageFormatter를 UuidViewableMessageFormatter로 변겨여하였다.
 *
 */
public final class UuidViewableLog4jLoggerAdapter extends MarkerIgnoringBase implements
   ...
   * log4j manual".
   */
  final static String FQCN = UuidViewableLog4jLoggerAdapter.class.getName();
  ...
  UuidViewableLog4jLoggerAdapter(org.apache.log4j.Logger logger) {
    this.logger = logger;
  ...
  public void trace(String format, Object arg) {
    if (isTraceEnabled()) {
      FormattingTuple ft = UuidViewableMessageFormatter.format(format, arg);
  ...
  public void trace(String format, Object arg1, Object arg2) {
    if (isTraceEnabled()) {
      FormattingTuple ft = UuidViewableMessageFormatter.format(format, arg1, arg2);
      logger.log(FQCN, traceCapable ? Level.TRACE : Level.DEBUG, ft
          .getMessage(), ft.getThrowable());
    }
  }
  ...
  public void trace(String format, Object[] argArray) {
    if (isTraceEnabled()) {
      FormattingTuple ft = UuidViewableMessageFormatter.arrayFormat(format, argArray);
      logger.log(FQCN, traceCapable ? Level.TRACE : Level.DEBUG, ft
          .getMessage(), ft.getThrowable());
    }
  }
