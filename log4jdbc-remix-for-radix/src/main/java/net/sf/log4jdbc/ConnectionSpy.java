...
import net.sf.log4jdbc.radix.PreparedStatementSpyForRadix;
 ...
 * @param spyLogDelegator
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException
  {
    ...
    try
    {
      ...
      return (PreparedStatement) reportReturn(methodCall, new PreparedStatementSpyForRadix(sql, this, statement, this.log));
    }
    catch (SQLException s)
    {
